namespace TCompiler.Types.CheckTypes.TCompileException
{
    ...
    public class InvalidVariableTypeException : CompileException
    {
        ...
        public InvalidVariableTypeException(int line, string variableName, string message="The variable {0} has an invalid type!") : base(line, string.Format(message, variableName))
        {
        }
    }
}