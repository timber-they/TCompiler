    ...
    public class Address
    {
        ...
        public Address NextAddress => BitOf != null
                                          ? (BitOf < 7
                                                 ...
                                                 : (ByteAddress >=
                                                    GlobalProperties.INTERNAL_MEMORY_BIT_VARIABLE_LIMIT &&
                                                    !IsInExtendedMemory
                                                        ? new Address (0, true, 0)
                                                        : new Address (ByteAddress + 1, IsInExtendedMemory, 0)))
                                          : (ByteAddress >= GlobalProperties.INTERNAL_MEMORY_BYTE_VARIABLE_LIMIT &&
                                             !IsInExtendedMemory
                                                 ? new Address (0, true)
        ...
        private bool IsInSpecialFunctionRegister () => ByteAddress >=
                                                       GlobalProperties.INTERNAL_MEMORY_BYTE_VARIABLE_LIMIT &&
                                                       !IsInExtendedMemory;
