...
namespace TIDE.Forms.Tools
{
    public static class Formatting
    {
        ...
        public static string FormatLine(string text, int line) => string.Join("\n",
            text.Split('\n').Select((s, i) => i == line ? FormatText(text).Split('\n')[i] : s));
        ...
        public static string FormatLines(string text, List<int> lines) => string.Join("\n",
            text.Split('\n').Select((s, i) => lines.Contains(i) ? FormatText(text).Split('\n')[i] : s));
    }
}